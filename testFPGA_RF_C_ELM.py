# -*- coding: utf-8 -*-
"""
Created on Thu Apr 07 17:21:55 2016
...
fpga_elm = FPGA_RF_C_ELM(28, 28, feature_dim*10, label_dim, 'lite', 'rf-c', train_data, H=0.25,\
                         randomPrec=3, actPrec=3, linearPrec=3, callPrec=3, fixedTrain = False, fixedTest=True)
...
#fpga_elm.save(r"D:\workspace\Data\ELM\weights\fpga_rf_c_elm")
